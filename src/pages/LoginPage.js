...
const LoginPage = () => {
  ...
  const {
    setFirstName: contextSetFirstname,
    setLastName: contextSetLastName,
    setEmail: contextSetEmail,
    setRole: contextSetRole
  ...
  const loginFunction = async () => {
    try {
      ...
      contextSetEmail(result.data.user.email);
      contextSetFirstname(result.data.user.fname);
      contextSetLastName(result.data.user.lname);
      contextSetRole(result.data.user.role);
          ...
          <div className="p-8  sm:w-[60%] bg-[#1b1a1a6b] flex justify-center">
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2 my-4">
                ...
                />
                <Link
                  className="text-xs text-gray-300 hover:text-gray-500 font-medium"
                  to="/signup"
                >
                  Create an Account
                </Link>
